...
export const pageContent: Record<string, PageContent> = {
  ...
  resources: {
    ...
    sections: [
      ...
      { title: t('Storage & shipping', '储存与运输', 'Хранение и доставка'), body: t('A practical checklist covering ambient, -20°C and 2–8°C transport, from shipping documents to receipt inspection.', '覆盖常温、-20℃和2℃～8℃运输的实用清单，从发运文件到收货检查。', 'Практический чек-лист для перевозки при комнатной температуре, -20 °C и 2–8 °C: от отгрузочных документов до проверки при получении.'), image: '/products/cold-chain.jpg' },
