...
export default function SiteFooter({
  ...
  return <>
    <footer className="stitch-footer site-footer">
      ...
      <div><p className="footer-label">CONTACT</p>{email ? <a href={email.href}>{email.value}</a> : <a href="mailto:zehongyan2025@outlook.com">zehongyan2025@outlook.com</a>}<a href={whatsapp}>WhatsApp</a><a href={vk}>VK</a></div>
